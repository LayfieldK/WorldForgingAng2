System.register(["@angular/core", "@angular/platform-browser", "@angular/http", "@angular/forms", "@angular/router", "rxjs/Rx", "./about.component", "./app.component", "./home.component", "./item-detail-view.component", "./item-detail-edit.component", "./item-list.component", "./login.component", "./page-not-found.component", "./app.routing", "./auth.http", "./auth.service", "./item.service"], function(exports_1, context_1) {
    ...
    var core_1, platform_browser_1, http_1, forms_1, router_1, about_component_1, app_component_1, home_component_1, item_detail_view_component_1, item_detail_edit_component_1, item_list_component_1, login_component_1, page_not_found_component_1, app_routing_1, auth_http_1, auth_service_1, item_service_1;
    var AppModule;
    return {
        setters:[
            function (core_1_1) {
