System.register(["@angular/core", "@angular/router", "./article", "./auth.service", "./article.service", "@angular/forms"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, article_1, auth_service_1, article_service_1, forms_1, ArticleDetailEditComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ArticleDetailEditComponent = (function () {
                function ArticleDetailEditComponent(authService, articleService, router, activatedRoute, formBuilder) {
                ...
                ArticleDetailEditComponent.prototype.ngOnInit = function () {
                    ...
                    this.activatedRoute.params
                        ...
                        _this.editArticleForm.setValue({
                            title: _this.article.Title,
                            description: _this.article.Description,
                            text: "",
                            eRelationships: _this.article.EntityRelationships
                        });
                    });
                };
                ...
                ArticleDetailEditComponent.prototype.addEntityRelationship = function () {
                    ...
                    var control = this.editArticleForm.controls['entityRelationships'];
