System.register(["@angular/core", "@angular/router", "./article", "./auth.service", "./article.service", "./relationship.service", "@angular/forms"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, article_1, auth_service_1, article_service_1, relationship_service_1, forms_1, ArticleDetailEditComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ArticleDetailEditComponent = (function () {
                function ArticleDetailEditComponent(authService, articleService, relationshipService, router, activatedRoute, formBuilder) {
