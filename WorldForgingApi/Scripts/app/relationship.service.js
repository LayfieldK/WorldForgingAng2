System.register(["@angular/core", "@angular/http", "rxjs/Observable", "./auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, RelationshipService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            RelationshipService = (function () {
                function RelationshipService(http) {
                    this.http = http;
                    this.baseUrl = "api/relationships/"; // web api URL
                }
                ...
                RelationshipService.prototype.get = function (id) {
                    if (id == null) {
                ...
                RelationshipService.prototype.search = function (term) {
                ...
                RelationshipService.prototype.add = function (relationship) {
                    var url = this.baseUrl;
                ...
                RelationshipService.prototype.update = function (relationship) {
                ...
                RelationshipService.prototype.delete = function (id) {
                    var url = this.baseUrl + id;
                    return this.http.delete(url)
                        .catch(this.handleError);
                };
                // returns a viable RequestOptions object to handle Json requests
                RelationshipService.prototype.getRequestOptions = function () {
                ...
                RelationshipService.prototype.handleError = function (error) {
            ...
            exports_1("RelationshipService", RelationshipService);
        }
    };
});
