...
public class DbSeeder
{
    ...
    #region Constructor
    public DbSeeder(WorldForgingDBContext dbContext)
    {
        DbContext = dbContext;
    }
    ...
    private void CreateTutorialItems()
    {
        ...
        {
            DbContext.TutorialItems.Add(GetSampleTutorialItem(id, authorId, num - id, new DateTime(2015, 12, 31).AddDays(-num)));
        }
#endif
    ...
    /// <returns></returns>
    private TutorialItem GetSampleTutorialItem(int id, string authorId, int viewCount, DateTime createdDate)
    {
